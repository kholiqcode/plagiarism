# Generated by Django 4.0.3 on 2022-03-18 11:13
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, null=True)),
                ('updated_at', models.DateTimeField(auto_now=True, null=True)),
                ('doc1', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='fn_lj_doc1', to='plagiarism.learningjurnal')),
                ('doc2', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='fn_lj_doc2', to='plagiarism.learningjurnal')),
            ],
            options={
